...
Initialize new project: remove placeholder content, configure project name, optionally setup technologies.

**IMPORTANT:** Run ONCE on fresh repository clone. Destructive - removes placeholders.
...
- Permanent changes
- Home page minimal (replace via PRP)
